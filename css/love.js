(function(window){
    ...
    Heart = function() {
        ...
        for (var i = 10; i < 30; i += 0.2) {
            ...
            y = 23 * Math.cos(t) - 5 * Math.cos(2 * t) - 2 * Math.cos(3 * t) - Math.cos(4 * t);
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            var ctx = this.tree.ctx, cirle1 = this.heart;
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || 'rgb(255,' + random(136, 255) + ',' + random(0, 70) + ')';
